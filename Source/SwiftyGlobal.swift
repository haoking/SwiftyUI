...
extension NotificationCenter
{
    ...
    fileprivate var selectorWrapper : ClosureWrapper<NotificationCenter>? {
        get {
    ...
    @objc
    private func selectorBlockFunc(_ sender: NotificationCenter)
    {
...
extension NSLock
{
    ...
    private var lockerHandler : ClosureWrapper<Void>? {
        get {
...
extension NSObject {
    ...
    open class func swizzleInstance(_ originalSelector: Selector, _ swizzledSelector: Selector)
    {
    ...
    open class func swizzleStatic(_ originalSelector: Selector, _ swizzledSelector: Selector)
    {
...
extension UIColor
{
    open var redValue: CGFloat { return CIColor(color: self).red }
    open var greenValue: CGFloat { return CIColor(color: self).green }
    open var blueValue: CGFloat { return CIColor(color: self).blue }
    open var alphaValue: CGFloat { return CIColor(color: self).alpha }
}
